...
module SEPA
  class Account
    ...
    attr_accessor :name, :iban, :bic, :account_number,
      ...
      :bank_account_type, :uk_sort_code
    ...
    validates_inclusion_of :bank_account_type, in: %w[BBAN BGNR], allow_nil: true
    validates_with BICValidator, IBANValidator, UkSortCodeValidator, message: "%{value} is invalid"
